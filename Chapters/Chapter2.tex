...
Para cuantificar la capacidad del modelo híbrido ($f_{hybrid}$) de replicar la realidad y corregir el sesgo del modelo físico, se emplea principalmente la raíz del error cuadrático medio (RMSE). 
